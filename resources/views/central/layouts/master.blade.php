...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'AirCloud') }} - @yield('page_title', 'Central Admin')</title>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .hero-card {
                ...
                padding: 24px;
                border-radius: 16px;
                background: linear-gradient(135deg, color-mix(in srgb, var(--primary) 88%, #0f172a) 0%, var(--primary) 100%);
                color: #ffffff;
                box-shadow: var(--shadow-md);
                position: relative;
                overflow: hidden;
            ...
            @media (max-width: 1023px) {
                ...
                body[data-sidebar-open="true"] .sidebar-shell {
                    transform: translateX(0);
                }

                body[data-sidebar-open="true"] .shell-backdrop {
                    opacity: 1;
                    pointer-events: auto;
                }
    ...
    <body data-sidebar-open="false">
        <div class="app-shell">
            ...
            <div class="content-shell">
                ...
                @include('central.layouts.partials.footer')
            </div>
        </div>
